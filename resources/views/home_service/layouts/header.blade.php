    ...
    <div class="navbar-container d-flex content">
        <div class="bookmark-wrapper d-flex align-items-center">
            ...
            <ul class="nav navbar-nav bookmark-icons">
                @php $unread = \App\Models\Chat::query()->where('provider_id', auth('home_service')->id())->where('provider_type', 3)->where('provider_unread_messages', '>', 0)->count() > 0; @endphp

                <li class="nav-item d-none d-lg-block" style="margin-top: 8px;">
                    <a class="nav-link" href="{{ route('home_service_chats.index') }}" data-bs-toggle="tooltip"
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                    ...
                    <div class="user-nav d-sm-flex d-none"><span
                            class="user-name fw-bolder">{{ auth('home_service')->user()->name }}</span><span
                            class="user-status">@lang('common.home_service')</span></div>
                    <span class="avatar"><img class="round" src="{{ auth('home_service')->user()->image }}" alt="avatar"
                                              height="40" width="40"><span class="avatar-status-online"></span></span>
                </a>
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    <a class="dropdown-item" href="{{ route('home_service.logout') }}"><i class="me-50"
