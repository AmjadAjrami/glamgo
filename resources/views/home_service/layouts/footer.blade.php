...
<script>
    ...
    function get_notifications(){
        ...
        $.ajax({
            url: '{{ url(app()->getLocale() . '/h-service/get_notifications/') }}/',
            method: 'GET',
            success: function (data) {
                ...
                $.each(data.notifications, function (index, value){
                    var href = '';
                    if(value.type == 'home_service_reservation_notification'){
                        href = '{{ url(app()->getLocale() . '/h-service/reservations') }}';
                    }
                    if(value.type == 'home_service_chat_notification'){
                        href = '{{ url(app()->getLocale() . '/h-service/chats?user_id=') }}' + value.user_id;
                    }
    ...
    var channel = pusher.subscribe('home_service-channel');
    channel.bind('event', function(data) {
        console.log(data);
        if(data.artist == {{ auth('home_service')->id() }}){
    ...
    $('#notification_btn').on('click', function (){
        ...
        $.ajax({
            url: '{{ url(app()->getLocale() . '/h-service/read_notifications/') }}/',
            method: 'GET',
            success: function (data) {
