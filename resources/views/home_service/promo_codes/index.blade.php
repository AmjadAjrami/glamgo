                ...
                <form id="search_form" style="margin-right: 25px;margin-top: 30px">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <input name="code" id="s_code" class="form-control" style="width: 15%; display: inline"
                                   placeholder="@lang('common.code')">
                            <select id="s_discount_type" name="discount_type" class="form-control"
                                    style="width: 15%; display: inline">
                                <option selected disabled>@lang('common.choose') @lang('common.discount_type')</option>
                                <option value="1">@lang('common.fixed')</option>
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="create_form" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" id="number_of_usage_for_user" name="number_of_usage_for_user" class="form-control"
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="editUserForm" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" id="edit_number_of_usage_for_user" name="number_of_usage_for_user" class="form-control"
                                   placeholder="{{ __('common.number_of_usage_for_user') }}" min="0"/>
                            @if($errors->has('number_of_usage_for_user'))
                                <div
                                    style="color: red">{{ $errors->first('number_of_usage_for_user') }}</div>
...
@section('scripts')
    <script>
        var url = '{{ url(app()->getLocale() . "/h-service/home_service_promo_codes/") }}/';
        ...
        var dt_adv_filter = $('#datatable').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    d.code = $('#s_code').val();
                    d.discount_type = $('#s_discount_type').val();
                }
            },
            columns: [
                {
                ...
                {data: 'number_of_usage_for_user', name: 'number_of_usage_for_user', orderable: false, searchable: false},
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#create_btn', function (event) {
                $('#create_form').attr('action', '{{ route('home_service_promo_codes.store') }}');
            });
        });
        ...
        function add_remove(id) {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/h-service/home_service_promo_codes/update_status/') }}/' + id,
                method: 'PUT',
