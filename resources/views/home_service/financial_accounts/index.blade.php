            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="datatable">
                        ...
                        <tbody>
                            @foreach($home_service_withdraws as $withdraw)
                                <tr>
                                    <td>{{ $loop->index + 1 }}</td>
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="datatable">
                        ...
                        <tbody>
                        @foreach($home_service_cash_transfers as $transfer)
                            <tr>
                                <td>{{ $loop->index + 1 }}</td>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="editUserForm" data-reset="true" method="POST" class="row gy-1 pt-75" action="{{ route('home_service_financial_accounts.make_withdraw') }}"
...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.change_status', function () {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/h-service/financial_accounts/update_status') }}',
                method: 'GET',
                data: {
                    id: id,
                    type: type,
