        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('common.home_service_info')</h4>
                </div>
                @include('flash::message')
                <div class="card-body">
                    <form data-reset="true" method="POST" class="row gy-1 pt-75" enctype="multipart/form-data" action="{{ route('home_service_info.update') }}">
                        @csrf
                        @method('PUT')
                        ...
                        @foreach(locales() as $key => $value)
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" id="name_{{ $key }}" name="name_{{ $key }}" class="form-control" value="{{ $home_service->translate($key)->name }}"
                        ...
                        @foreach(locales() as $key => $value)
                            <div class="col-12 col-md-12">
                                ...
                                <textarea type="text" id="edit_bio_{{ $key }}" name="bio_{{ $key }}"
                                          ...
                                          placeholder="{{ __('common.bio') . ' - ' . __('common.'.$value) }}">{{ $home_service->translate($key)->bio }}</textarea>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="email" id="email" name="email" class="form-control"
                                   placeholder="{{ __('common.email') }}" value="{{ $home_service->email }}"/>
                            @if($errors->has('email'))
                                <div
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="tel" id="edit_mobile" name="mobile" class="form-control"
                                   placeholder="{{ __('common.mobile') }}" value="{{ $home_service->mobile }}"/>
...
{{--                                <option selected disabled>@lang('common.choose')</option>--}}
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" {{ in_array($category->id, $home_service->home_service_categories->pluck('category_id')->toArray()) ? 'selected' : '' }}>{{ $category->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="bank_name" name="bank_name" class="form-control" value="{{ $home_service->bank_name }}"
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="bank_account_name" name="bank_account_name" class="form-control" value="{{ $home_service->bank_account_name }}"
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" id="iban" name="iban" class="form-control" value="{{ $home_service->iban }}"
                        ...
                        <div class="col-6">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;"
                                    ...
                                    <img src="{{ $home_service->image }}" alt="...">
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;"
                                     data-trigger="fileinput">
                                    <img src="{{ $home_service->cover_image }}" alt="...">
                                </div>
                                <div class="fileinput-preview fileinput-exists thumbnail"
                                     style="max-width: 200px; max-height: 150px"></div>
                                <div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <video style="width: 205px;height: 155px" controls>
                                    <source src="{{ $home_service->video }}" id="edit_video_here">
                                </video>
                                <br>
                                <span class="btn btn-white btn-file">
                        ...
                        <div class="col-6">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;"
                                     data-trigger="fileinput">
                                    <img src="{{ $home_service->thumbnail }}" alt="...">
                                </div>
                                <div class="fileinput-preview fileinput-exists thumbnail"
                                     style="max-width: 200px; max-height: 150px"></div>
                                <div>
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                   for="end_date">{{ __('common.home_service_images') }}</label>
...
@section('scripts')
    ...
    <script>
        ...
        var images = @json($home_service->gallery);
