...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item me-auto">
                <a class="navbar-brand" href="{{ route('salon.dashboard') }}">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item {{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon' ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('salon.dashboard') }}"><i
                        data-feather="home"></i><span class="menu-title text-truncate"
                                                      data-i18n="Email">@lang('common.home')</span></a>
            </li>
            <li class=" nav-item {{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_info' ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('salon_info.index') }}">
                            ...
                            <g xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                                        ...
                                        fill="{{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_info' ? '#ffffff' : '#000000' }}"
                    ...
                    <span class="menu-title text-truncate" data-i18n="Email">@lang('common.salon_info')</span>
                </a>
            </li>
            <li class=" nav-item {{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_service_types' ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('salon_service_types.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                         width="512" height="512" x="0" y="0"
                         viewBox="0 0 64 64"
                         style="{{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_service_types' ? 'fill: rgb(231 231 231) !important;' : 'fill: rgb(98 95 110) !important' }}"
                            ...
                            <g xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                                        ...
                                        fill="{{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_service_types' ? '#ffffff' : '#000000' }}"
            ...
            <li class=" nav-item {{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_services' ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('salon_services.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                         width="512" height="512" x="0" y="0"
                         viewBox="0 0 64 64"
                         ...
                         xml:space="preserve" class=""><g>
                            <g xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                                        d="m55.3 62h-13.6c-3.7 0-6.7-3-6.7-6.7v-18.3c0-1.1.9-2 2-2h18.3c3.7 0 6.7 3 6.7 6.7v13.6c0 3.7-3 6.7-6.7 6.7zm-16.3-23v16.3c0 1.5 1.2 2.7 2.7 2.7h13.6c1.5 0 2.7-1.2 2.7-2.7v-13.6c0-1.5-1.2-2.7-2.7-2.7z"
                                        fill="{{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_services' ? '#ffffff' : '#000000' }}"
                                        data-original="#000000" class=""></path>
                                </g>
                                <g>
                                    <path
            ...
            <li class="nav-item {{ request()->type == 1 ? 'open' : '' }}">
                ...
                <ul class="menu-content">
                    <li class="nav-item {{ request()->type == 1 && strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_booking_times' ? 'active' : '' }}">
                        <a class="d-flex align-items-center"
                           href="{{ url(app()->getLocale() . '/salon/booking_times?type=1') }}"><i
                                data-feather="circle"></i><span class="menu-item text-truncate"
                                                                data-i18n="List">@lang('common.booking_times_in_salon')</span></a>
                    </li>
                    <li class="nav-item {{ request()->type == 2 && strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_booking_times' ? 'active' : '' }}">
                        <a class="d-flex align-items-center"
                           href="{{ url(app()->getLocale() . '/salon/booking_times?type=2') }}"><i
                                data-feather="circle"></i><span class="menu-item text-truncate"
                                                                data-i18n="List">@lang('common.booking_times_out_salon')</span></a>
                    </li>
                </ul>
            </li>
{{--            <li class=" nav-item {{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_booking_times' ? 'active' : '' }}">--}}
{{--                <a class="d-flex align-items-center" href="{{ route('salon_booking_times.index') }}">--}}
{{--                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"--}}
{{--                         width="512" height="512" x="0" y="0"--}}
{{--                         viewBox="0 0 511.992 511.992" style="enable-background:new 0 0 512 512" xml:space="preserve"--}}
{{--                         class=""><g>--}}
...
{{--                                    <path id="XMLID_389_"--}}
{{--                                          d="M511.005,279.646c-4.597-46.238-25.254-89.829-58.168-122.744    c-28.128-28.127-62.556-46.202-98.782-54.239V77.255c14.796-3.681,25.794-17.074,25.794-32.993c0-18.748-15.252-34-34-34h-72    c-18.748,0-34,15.252-34,34c0,15.918,10.998,29.311,25.793,32.993v25.479c-36.115,8.071-70.429,26.121-98.477,54.169    c-6.138,6.138-11.798,12.577-16.979,19.269c-0.251-0.019-0.502-0.038-0.758-0.038H78.167c-5.522,0-10,4.477-10,10s4.478,10,10,10    h58.412c-7.332,12.275-13.244,25.166-17.744,38.436H10c-5.522,0-10,4.477-10,10s4.478,10,10,10h103.184    c-2.882,12.651-4.536,25.526-4.963,38.437H64c-5.522,0-10,4.477-10,10s4.478,10,10,10h44.54    c0.844,12.944,2.925,25.82,6.244,38.437H50c-5.522,0-10,4.477-10,10s4.478,10,10,10h71.166    c9.81,25.951,25.141,50.274,45.999,71.132c32.946,32.946,76.582,53.608,122.868,58.181c6.606,0.652,13.217,0.975,19.819,0.975    c39.022,0,77.548-11.293,110.238-32.581c4.628-3.014,5.937-9.209,2.923-13.837s-9.209-5.937-13.837-2.923    c-71.557,46.597-167.39,36.522-227.869-23.957c-70.962-70.962-70.962-186.425,0-257.388c70.961-70.961,186.424-70.961,257.387,0    c60.399,60.4,70.529,156.151,24.086,227.673c-3.008,4.632-1.691,10.826,2.94,13.833c4.634,3.008,10.826,1.691,13.833-2.941    C504.367,371.396,515.537,325.241,511.005,279.646z M259.849,44.263c0-7.72,6.28-14,14-14h72c7.72,0,14,6.28,14,14s-6.28,14-14,14    h-1.794h-68.413h-1.793C266.129,58.263,259.849,51.982,259.849,44.263z M285.642,99.296V78.263h48.413v20.997    C317.979,97.348,301.715,97.36,285.642,99.296z"--}}
{{--                                          fill="{{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_booking_times' ? '#ffffff' : '#000000' }}"--}}
{{--                                          data-original="#000000" class=""></path>--}}
{{--                                    <path id="XMLID_391_"--}}
{{--                                          d="M445.77,425.5c-2.64,0-5.21,1.07-7.069,2.93c-1.87,1.86-2.931,4.44-2.931,7.07    c0,2.63,1.061,5.21,2.931,7.07c1.859,1.87,4.43,2.93,7.069,2.93c2.63,0,5.2-1.06,7.07-2.93c1.86-1.86,2.93-4.44,2.93-7.07    c0-2.63-1.069-5.21-2.93-7.07C450.97,426.57,448.399,425.5,445.77,425.5z"--}}
{{--                                          fill="{{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_booking_times' ? '#ffffff' : '#000000' }}"--}}
...
{{--                </a>--}}
{{--            </li>--}}
            <li class=" nav-item {{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_promo_codes' ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('salon_promo_codes.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="512" height="512" x="0" y="0"
                         viewBox="0 0 24 24" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g>
                            <path
                                ...
                                fill="{{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_promo_codes' ? '#ffffff' : '#000000' }}"
                                data-original="#000000" class=""></path>
                            <path
            ...
            <li class=" nav-item {{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_reservations' ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('salon_reservations.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                         width="512" height="512" x="0" y="0"
                         viewBox="0 0 512 512"
                         style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g>
                            <g>
                                <path
                                    ...
                                    fill="{{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_reservations' ? '#ffffff' : '#000000' }}"
                                    data-original="#000000" class=""></path>
                                <path
            ...
            <li class=" nav-item {{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_chats' ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('salon_chats.index') }}">
                    <i class="ficon" data-feather="message-square"></i>
                    <span class="menu-title text-truncate" data-i18n="Email">@lang('common.chats')</span>
                </a>
            </li>
            <li class=" nav-item {{ strtok(\Illuminate\Support\Facades\Route::currentRouteName(),'.') == 'salon_financial_accounts' ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('salon_financial_accounts.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="512" height="512" x="0" y="0"
