...
<script>
    ...
    function get_notifications(){
        ...
        $.ajax({
            url: '{{ url(app()->getLocale() . '/salon/get_notifications/') }}/',
            method: 'GET',
            success: function (data) {
                ...
                $.each(data.notifications, function (index, value){
                    var href = '';
                    if(value.type == 'salon_reservation_notification'){
                        href = '{{ url(app()->getLocale() . '/salon/reservations') }}';
                    }
                    if(value.type == 'salon_chat_notification'){
                        href = '{{ url(app()->getLocale() . '/salon/chats?user_id=') }}' + value.user_id;
                    }
    ...
    var channel = pusher.subscribe('salon-channel');
    channel.bind('event', function(data) {
        console.log(data);
        if(data.salon == {{ auth('salon')->id() }}){
    ...
    $('#notification_btn').on('click', function (){
        ...
        $.ajax({
            url: '{{ url(app()->getLocale() . '/salon/read_notifications/') }}/',
            method: 'GET',
            success: function (data) {
