            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="create_form" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                        ...
                        <div class="col-12 col-md-6">
                            <label class="form-label"
                                   for="service_category">{{ __('common.service_category') }}</label>
                            <select id="service_category" name="service_category" class="form-control">
                                <option selected disabled>@lang('common.choose')</option>
                                <option value="1">@lang('common.internal_services')</option>
                                <option value="2">@lang('common.external_services')</option>
                                <option value="3">@lang('common.both')</option>
                            </select>
                            @if($errors->has('service_category'))
                                <div
                                    style="color: red">{{ $errors->first('service_category') }}</div>
                            @endif
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="editUserForm" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                        ...
                        <div class="col-12 col-md-6">
                            <label class="form-label"
                                   for="edit_service_category">{{ __('common.service_category') }}</label>
                            <select id="edit_service_category" name="service_category" class="form-control">
                                <option selected disabled>@lang('common.choose')</option>
                                <option value="1">@lang('common.internal_services')</option>
                                <option value="2">@lang('common.external_services')</option>
                                <option value="3">@lang('common.both')</option>
...
@section('scripts')
    <script>
        ...
        var url = '{{ url(app()->getLocale() . "/salon/salon_services/") }}/';
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#create_btn', function (event) {
                $('#create_form').attr('action', '{{ route('salon_services.store') }}');
            });
        });
        ...
        function add_remove(id) {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/salon/salon_services/update_status/') }}/' + id,
                method: 'PUT',
        ...
        $(document).on('change', '.is_completed', function () {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/salon/salon_services/update_is_completed_status') }}',
                method: 'PUT',
                data: {
                    id: id,
