                    ...
                    <div class="row">
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                            <div class="d-flex flex-row">
                                ...
                                <div class="my-auto">
                                    <h4 class="fw-bolder mb-0">{{ $details['orders_price'] }} @lang('common.rq')</h4>
                                    <p class="card-text font-small-3 mb-0">@lang('common.orders_price')</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                            <div class="d-flex flex-row">
                                ...
                                <div class="my-auto">
                                    <h4 class="fw-bolder mb-0">{{ $details['app_percentage_store'] }} @lang('common.rq')</h4>
                                    <p class="card-text font-small-3 mb-0">@lang('common.app_percentage_store')</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                        ...
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                            <div class="d-flex flex-row">
                                ...
                                <div class="my-auto">
                                    <h4 class="fw-bolder mb-0">{{ $details['app_percentage_reservations'] }} @lang('common.rq')</h4>
                                    <p class="card-text font-small-3 mb-0">@lang('common.app_percentage_reservations')</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0" style="margin-top: 40px">
                            <div class="d-flex flex-row">
                        ...
                        <hr style="margin-top: 50px !important;height: 3px !important;">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="datatable">
                        ...
                        <tbody>
                        @foreach($salon_withdraws as $withdraw)
                            <tr>
                                <td>{{ $loop->index + 1 }}</td>
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="datatable">
                        ...
                        <tbody>
                        @foreach($salon_cash_transfers as $transfer)
                            <tr>
                                <td>{{ $loop->index + 1 }}</td>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="editUserForm" data-reset="true" method="POST" class="row gy-1 pt-75" action="{{ route('salon_financial_accounts.make_withdraw') }}"
...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.change_status', function () {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/salon/financial_accounts/update_status') }}',
                method: 'GET',
                data: {
                    id: id,
                    type: type,
