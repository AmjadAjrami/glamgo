...
@section('scripts')
    <script>
        var url = '{{ url(app()->getLocale() . "/artist/artist_promo_codes/") }}/';
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#create_btn', function (event) {
                $('#create_form').attr('action', '{{ route('artist_promo_codes.store') }}');
            });
        });
        ...
        function add_remove(id) {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/artist/artist_promo_codes/update_status/') }}/' + id,
                method: 'PUT',
