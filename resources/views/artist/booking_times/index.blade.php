        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="table-responsive">
                    <a href="{{ route('artist_booking_times.add_times', request()->type) }}" class="btn btn-success"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="time_settingsForm" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                          onsubmit="return false" enctype="multipart/form-data"
                          action="{{ route('artist_booking_times.time_settings') }}">
                        @csrf
                        <div class="col-12 col-md-12">
                            <div class="row">
                                <div class="row" id="edit_times">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.edit_btn', function (event) {
                ...
                $.ajax({
                    url: '{{ url(app()->getLocale() . '/artist/booking_times/day') }}',
                    method: 'GET',
                    data: {
                ...
                $('#editUserForm').attr('action', '{{ url(app()->getLocale() . '/artist/booking_times/update') }}');
            });
