...
@section('scripts')
    ...
    <script>
        ...
        var url = '{{ url(app()->getLocale() . "/artist/artist_service_types") }}/';
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#create_btn', function (event) {
                $('#create_form').attr('action', '{{ route('artist_service_types.store') }}');
            });
        });
        ...
        function add_remove(id) {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/artist/artist_service_types/update_status/') }}/' + id,
                method: 'PUT',
