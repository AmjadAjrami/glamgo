...
@section('scripts')
    <script>
        ...
        var url = '{{ url(app()->getLocale() . "/artist/artist_services/") }}/';
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#create_btn', function (event) {
                $('#create_form').attr('action', '{{ route('artist_services.store') }}');
            });
        });
        ...
        function add_remove(id) {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/artist/artist_services/update_status/') }}/' + id,
                method: 'PUT',
        ...
        $(document).on('change', '.is_completed', function () {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/artist/artist_services/update_is_completed_status') }}',
                method: 'PUT',
                data: {
                    id: id,
