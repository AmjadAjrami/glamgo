@php
    ...
    $setting_secretKey = \App\Models\Setting::query()->where('key', 'secretKey')->first()->value;

     $sadad_checksum_array = array();
     $sadad__checksum_data = array();
     $txnDate = date('Y-m-d H:i:s');
     $email ='example@example.com';
     $secretKey = $setting_secretKey;
     $merchantID = $sadadId;
...
<div id="sadad_cc_container" data-sd-lang="{{ $lang }}" data-i-color="#cd6a77" data-apple-enable="1"
     data-apple-sadadid="3163340" data-apple-bizname="Glamgo App Electronic" data-apple-domain="glamgoapp.com"
     data-cbfunc="sadadGetChecksum"></div>
<div id="sadad_div">
