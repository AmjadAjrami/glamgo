                ...
                <form id="search_form" style="margin-right: 25px;margin-top: 30px">
                    ...
                    <div class="form-row">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <select name="salon_id" id="s_salon_id" class="form-control select2">
                                    <option selected disabled>@lang('common.choose') @lang('common.salon')</option>
                            ...
                            <div class="col-2">
                                <select name="artist_id" id="s_artist_id" class="form-control select2">
                                    <option selected disabled>@lang('common.choose') @lang('common.artist')</option>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="datatable">
                        ...
                        <tr>
                            ...
                            <th>@lang('common.provider_name')</th>
                            <th>@lang('common.provider_type')</th>
...
@section('scripts')
    <script>
        var url = '{{ url(app()->getLocale() . "/tmg/reservations") }}/';
        ...
        var dt_adv_filter = $('#datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'provider_name', name: 'provider_name', orderable: false, searchable: false},
                {data: 'provider_type', name: 'provider_type', orderable: false, searchable: false},
                ...
                },
                {
                    "render": function (data, type, full, meta) {
                        ...
                        if (full.status == 1) {
                            status = '@lang('common.under_confirmation')';
                        } else if (full.status == 2) {
                            status = '@lang('common.confirmed')';
                        } else if (full.status == 3) {
                            status = '@lang('common.completed')';
                        } else if (full.status == 4) {
                            status = '@lang('common.canceled')';
                        } else if (full.status == 5) {
                            status = '@lang('common.rejected')';
                        }
        ...
        $(document).on('change', '.reservation_status', function () {
            ...
            if (status == 5) {
                ...
                $('#editUserForm').attr('action', '{{ url(app()->getLocale() . '/tmg/reservations/update_status') }}');
                ...
                $.ajax({
                    url: '{{ url(app()->getLocale() . '/tmg/reservations/update_status') }}',
                    method: 'PUT',
                    data: {
                        reservation_id: id,
                        status: status,
        ...
        $(document).on('click', '.reservation_details', function () {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/tmg/reservations/reservation_details') }}',
                method: 'GET',
                data: {
                    reservation_id: id,
                },
                ...
                success: function (data) {
                    ...
                    if (data.reservation.offer_id == null) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td>' + price + '</td>' +
                            '<td>' + (price * data.reservation.quantity) + '</td>' +
                            '</tr>';
                    }
