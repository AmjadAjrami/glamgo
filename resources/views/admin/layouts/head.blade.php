...
<head>
    ...
    <title>@lang('common.project_title')</title>
...
@else
    ...
    @endif
{{--    <link rel="stylesheet" href="{{ asset('app-assets/file-uploader/neon-core.css') }}">--}}
{{--    <link rel="stylesheet" href="{{ asset('app-assets/file-uploader/neon-theme.css') }}">--}}
