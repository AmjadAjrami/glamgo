        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('common.privacy')</h4>
                </div>
                <div class="card-body">
                    @if(!$page)
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    <div class="text-center mb-2">
                        <h1 class="mb-1">@lang('common.add') @lang('common.privacy')</h1>
                    </div>
    ...
    <div class="modal fade" id="editUser" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    <div class="text-center mb-2">
                        <h1 class="mb-1">@lang('common.edit') @lang('common.privacy')</h1>
                    </div>
...
@section('scripts')
    <script>
        var url = '{{ url(app()->getLocale() . "/tmg/privacy") }}/';
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#create_btn', function (event) {
                $('#create_form').attr('action', '{{ route('privacy.store') }}');
            });
        });
