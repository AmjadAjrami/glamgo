        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('common.cities')</h4>
                </div>
                <div class="card-body">
                    @if(auth()->user()->hasAnyPermission(['add_city']))
                ...
                <form id="search_form" style="margin-right: 25px;margin-top: 30px">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="s_country_id" name="country_id" class="form-control"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    <div class="text-center mb-2">
                        <h1 class="mb-1">@lang('common.add') @lang('common.city')</h1>
                    </div>
                    <form id="create_form" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                        ...
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="country_id">@lang('common.countries')</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="editUserForm" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                        ...
                        @endforeach
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="edit_country_id">@lang('common.countries')</label>
...
@section('scripts')
    ...
    <script>
        var url = '{{ url(app()->getLocale() . "/tmg/cities") }}/';
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#create_btn', function (event) {
                $('#create_form').attr('action', '{{ route('cities.store') }}');
            });
        });
        ...
        function add_remove(id) {
            ...
            $.ajax({
                url: '{{ url(app()->getLocale() . '/tmg/cities/update_status/') }}/' + id,
                method: 'PUT',
