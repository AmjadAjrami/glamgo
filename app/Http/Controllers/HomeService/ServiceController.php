...
class ServiceController extends Controller
{
    ...
    {
        $service_types = ServiceType::query()->where('home_service_id', auth('home_service')->id())->where('status', 1)->get();
        return view('home_service.services.index', compact('service_types'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('home_service_services.index'));
    }
    ...
    {
        $services = Service::query()->where('home_service_id', auth('home_service')->id())->orderByDesc('created_at');
