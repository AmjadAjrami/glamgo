...
class HomeServiceInfoController extends Controller
{
    /**
     *
     */
    ...
    public function index()
    {
        ...
        return view('home_service.home_service_info.index', compact('home_service', 'categories'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $rules = [
            ...
            'email' => 'required|email|unique:home_services,email,' . $home_service->id,
            'mobile' => 'required|unique:home_services,mobile,' . $home_service->id,
            'password' => 'nullable',
            'video' => 'nullable',
        ...
        if ($request->video){
            ...
            HomeServiceGallery::query()->where('home_service_id', $home_service->id)->where('type', 2)->update([
                'makeup_artist_id' => $home_service->id,
        ...
        return redirect(route('home_service_info.index'));
    }
