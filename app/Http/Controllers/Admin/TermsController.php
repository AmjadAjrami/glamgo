...
class TermsController extends Controller
{
    ...
    {
        $page = Page::query()->where('type', 2)->exists();
        return view('admin.pages.terms.index', compact('page'));
    }
    ...
    {
        $pages = Page::query()->where('type', 2)->orderByDesc('created_at');
        return DataTables::of($pages)
            ->addColumn('action', function ($page) {
                ...
                if (auth()->user()->hasAnyPermission(['edit_terms'])) {
