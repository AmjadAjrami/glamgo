...
class PrivacyController extends Controller
{
    ...
    {
        $page = Page::query()->where('type', 3)->exists();
        return view('admin.pages.privacy.index', compact('page'));
    }
    ...
    {
        $pages = Page::query()->where('type', 3)->orderByDesc('created_at');
        return DataTables::of($pages)
            ->addColumn('action', function ($page) {
                ...
                if (auth()->user()->hasAnyPermission(['edit_privacy'])) {
