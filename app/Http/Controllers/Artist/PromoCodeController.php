...
class PromoCodeController extends Controller
{
    ...
    {
        return view('artist.promo_codes.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('artist_promo_codes.index'));
    }
    ...
    {
        $codes = PromoCode::query()->orderByDesc('created_at')->where('makeup_artist_id', auth('artist')->id());
