...
class ServiceTypeController extends Controller
{
    ...
    {
        return view('artist.service_types.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('artist_service_types.index'));
    }
    ...
    {
        $artist_service_types = ServiceType::query()->where('makeup_artist_id', auth('artist')->id())->orderByDesc('created_at');
        return DataTables::of($artist_service_types)->filter(function ($query) use ($request) {
            if ($request->status) {
