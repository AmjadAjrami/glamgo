...
class ReservationController extends Controller
{
    ...
    {
        return view('artist.reservations.index');
    }
    ...
    {
        $reservations = Reservation::query()->where('makeup_artist_id', auth('artist')->id())->whereNotNull('date')->orderByDesc('created_at');
    ...
    public function user_chat($user_id)
    {
        ...
        $chat = Chat::query()->where('provider_id', auth('artist')->id())->where('provider_type', 2)->where('user_id', $user->id)->get()->first();
