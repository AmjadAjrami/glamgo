...
class PromoCodeController extends Controller
{
    ...
    {
        return view('salon.promo_codes.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('salon_promo_codes.index'));
    }
    ...
    {
        $codes = PromoCode::query()->orderByDesc('created_at')->where('salon_id', auth('salon')->id());
